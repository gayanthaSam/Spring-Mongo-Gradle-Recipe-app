...
create table recipe (cook_time integer, prep_time integer, servings integer, id bigint not null auto_increment, notes_id bigint, description varchar(255), url varchar(255), difficulty enum ('EASY','HARD','MODERATE'), directions tinytext, image tinyblob, primary key (id)) engine=InnoDB;
