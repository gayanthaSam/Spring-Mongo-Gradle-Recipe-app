package gayantha.springframework.spring_recipe_app.bootstrap;
...
import gayantha.springframework.spring_recipe_app.domain.Difficulty;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
        ...
        private List<Recipe> getRecipes() {
                ...
                if (!eachUomOptional.isPresent()) {
                        throw new RuntimeException("Expected measure not found!");
                }
                ...
                guacRecipe.addIngredients(new Ingredient("minced red onion or thinly sliced green onion",
                                new BigDecimal(2), tablespoonUom));
                guacRecipe.addIngredients(new Ingredient("serrano chiles, stems and seeds removed, minced",
                ...
                guacRecipe.addIngredients(new Ingredient("ripe tomato, seeds and pulp removed, chopped",
                ...
                tacosRecipe.addIngredients(
                                new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), cupUom));
